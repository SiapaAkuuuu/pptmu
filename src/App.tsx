...
const images = [
  ...
  "https://github.com/SiapaAkuuuu/pptmu/blob/main/assets/3.png?raw=true",
  "https://github.com/SiapaAkuuuu/pptmu/blob/main/assets/4.png?raw=true",
  "https://github.com/SiapaAkuuuu/pptmu/blob/main/assets/5.png?raw=true",
];
